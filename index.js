...
const mysqlUrl = "mysql://root:fEoPjwLjXDieJIkgpWTmcAUQHQDlQbww@trolley.proxy.rlwy.net:31905/railway";

const url = new URL(mysqlUrl);

const DBHOST = url.hostname;             // trolley.proxy.rlwy.net
const DBPORT = url.port;                 // 31905
const DBUSER = url.username;             // root
const DBPASSWORD = url.password;         // fEoPjwLjXDieJIkgpWTmcAUQHQDlQbww
const DBDATABASE = url.pathname.substring(1); // railway (sin la barra inicial)
